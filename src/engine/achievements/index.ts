...
const DEFINITIONS: Omit<Achievement, 'unlocked'>[] = [
  {
    ...
    icon: '🌱',
    color: '#10b981',
    description: 'Criou o primeiro flashcard',
  },
  {
    id: 'first_review',
    ...
    icon: '🔄',
    color: '#06b6d4',
    description: 'Completou a primeira sessão de revisão',
  },
  {
    id: 'streak_3',
    ...
    icon: '🔥',
    color: '#f59e0b',
    description: 'Manteve sequência de 3 dias consecutivos',
  },
  {
    id: 'streak_7',
  ...
  },
  {
    ...
    icon: '👑',
    color: '#7c3aed',
    description: 'Manteve sequência de 30 dias consecutivos',
  },
  {
    id: 'cards_10',
    name: 'Colecionador',
  ...
  },
  {
    ...
    icon: '🎯',
    color: '#ec4899',
    description: 'Completou 10 sessões de revisão',
  },
  {
    id: 'reviews_50',
    name: 'Estudioso',
    icon: '🦉',
    color: '#7c3aed',
    description: 'Completou 50 sessões de revisão',
  },
  {
    id: 'xp_100',
    name: 'Iniciante XP',
...
function isUnlocked(id: string, state: AppState): boolean {
  switch (id) {
    ...
    case 'cards_10':
      return state.cards.length >= 10
    case 'cards_50':
      return state.cards.length >= 50
    case 'cards_100':
      return state.cards.length >= 100
    case 'reviews_10':
      return state.sessions.length >= 10
    case 'reviews_50':
      return state.sessions.length >= 50
    case 'xp_100':
      return (state.totalXp ?? 0) >= 100
    case 'xp_1000':
      return (state.totalXp ?? 0) >= 1000
    default:
      return false
  }
}
