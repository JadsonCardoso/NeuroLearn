...
// ── Retention ─────────────────────────────────────────────────────────────
export { calcStability, calcRetentionFromDays, calcRetention } from './retention/retentionModel'
...
export type { SkillSnapshot, SkillEvolution, SkillTrend } from './skill-evolution/skillProgression'
...
export type { CognitiveScoreInput, CognitiveScoreOutput } from './cognitive-score/cognitiveScore'

// ── Achievements ──────────────────────────────────────────────────────────
export { computeAchievements, ACHIEVEMENT_COUNT } from './achievements'
